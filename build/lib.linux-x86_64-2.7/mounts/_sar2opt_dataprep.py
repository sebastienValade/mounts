...
pairs.append('S1-20170729T050754_S2-20170730T100031')  # test image
...
for k, r in enumerate(pairs[start_idx::], start=start_idx):
    ...
    gpt.get_bandnames(prod2export_s1, print_bands=None)
    ...
    # =====================================================================
    # utilme.save_dict2yaml(s1_metadata, f_out='s1_metadata.yml', p_out=dir_pair)
    # utilme.save_dict2yaml(s2_metadata, f_out='s2_metadata.yml', p_out=dir_pair)
